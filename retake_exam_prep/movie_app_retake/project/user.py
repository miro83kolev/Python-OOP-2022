...
class User:
    ...
    def username(self, value):
        Validator.check_if_string_is_not_empty(value, 'Invalid username!')
    ...
    @age.setter
    def age(self, value):
        Validator.check_if_value_below_min_value(value, 6, 'Users under the age of 6 are not allowed!')
        self.__age = value
