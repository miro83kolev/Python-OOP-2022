...
class BookstoreTests(TestCase):
    ...
    # test title does not exist and add is correctly with 0 and 1 quantity
    ...
    # test sell book if book does not exist
    ...
    # test sell when not enough copies
    ...
    # test str method - receive 2 time, sell 1, str output
    ...
    # test sold books correct number
